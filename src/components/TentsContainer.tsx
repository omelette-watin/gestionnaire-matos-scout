    ...
    <div>
      ...
      <div
        className={classNames(
          "fixed inset-0 z-50 items-center justify-center bg-black/30 text-white",
          {
            hidden: !showFilters,
            flex: showFilters,
          }
      ...
      >
        <div
          className="h-full w-full bg-white p-4 text-black sm:h-fit sm:w-[400px] sm:rounded-lg sm:shadow-lg"
        ...
        >
          ...
          <div className="flex w-full flex-col items-center">
            ...
            <div className="flex w-full items-center justify-around">
              ...
              <div
                className="mt-5 flex w-fit cursor-pointer items-center space-x-2 rounded-full bg-black p-2 text-lg text-white shadow-lg transition hover:scale-[0.98] hover:shadow-sm"
