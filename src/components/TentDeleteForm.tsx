    ...
    <div className="flex flex-col items-center space-y-8 py-5">
      ...
      <div className="flex items-center justify-between space-x-5">
        ...
        <button
          ...
          disabled={submitting}
          className="flex w-fit items-center space-x-3 rounded-3xl bg-red-500 px-5 py-2 text-lg text-white shadow-lg transition hover:scale-[0.98] hover:shadow-sm disabled:bg-red-400"
        >
          <FaTrashAlt />
          <span>Supprimer</span>
        </button>
